...
const initialInputState: VendorInputFields = {
  vendorName: '',
  vendorIndustry: '',
  companySize: '',
  keyInformation: '',
...
export default function VendorInsightsPage() {
  ...
  const getPrintStyles = () => `
    <style>
      body { font-family: 'Inter', sans-serif; margin: 0; padding: 20px; color: #333; background-color: #fff; }
      .report-container { border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
      h1, h2, h3, h4 { color: #3F51B5; margin-top: 0; }
      h1 { font-size: 28px; text-align: center; margin-bottom: 20px; border-bottom: 2px solid #3F51B5; padding-bottom: 10px;}
      h2 { font-size: 22px; margin-top: 25px; margin-bottom: 10px; color: #009688; border-bottom: 1px solid #eee; padding-bottom: 5px;}
      h3 { font-size: 18px; margin-top: 20px; margin-bottom: 8px; color: #555; }
      h4 { font-size: 16px; margin-top: 15px; margin-bottom: 5px; color: #777; }
      p, li { line-height: 1.6; font-size: 14px; margin-bottom: 10px; }
      ...
      th { background-color: #f0f4ff; color: #3F51B5; font-weight: bold; }
      .summary-table th:first-child { width: 100px; }
      .risk-level-display { padding: 10px; border-radius: 6px; margin-top: 5px; font-weight: bold; text-align: center; }
      ...
      .analysis-section { white-space: pre-wrap; background-color: #f9f9f9; padding: 15px; border-radius: 6px; border: 1px solid #eee; }
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center py-8 px-4">
      ...
      {report && !isLoading && (
        <Card className="mt-8 w-full max-w-3xl shadow-xl transition-all duration-500 ease-in-out opacity-100 transform scale-100 rounded-lg">
          ...
          <CardContent className="pt-2 space-y-6">
            ...
            <section>
              <h3 className="text-xl font-semibold text-accent mb-3 font-headline border-b pb-2">Vendor Data Bank</h3>
            ...
            <section>
              <h3 className="text-xl font-semibold text-accent mb-3 font-headline border-b pb-2">Summary of Vendor Financial Evaluations</h3>
              ...
              <h4 className="text-md font-semibold text-foreground mt-4 mb-1">Overall Financial Evaluation Result:</h4>
            ...
            <section>
              <h3 className="text-xl font-semibold text-accent mb-3 font-headline border-b pb-2">Financial Risk Level</h3>
            ...
            <section>
              <h3 className="text-xl font-semibold text-accent mb-3 font-headline border-b pb-2">Detailed Analysis</h3>
            ...
            <section>
              <h3 className="text-xl font-semibold text-accent mb-3 font-headline border-b pb-2">Financial Sub-Element Criteria (Legend)</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm border">
                  <thead className="bg-muted">
                    <tr>
